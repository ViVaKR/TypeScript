...
console.log(`not g : ${(_a = str.match(/a/)) === null || _a === void 0 ? void 0 : _a.input} -> ${str.match(/a/)}`);
console.log(`not g : ${(_b = str.match(/a/g)) === null || _b === void 0 ? void 0 : _b.length}`);
(_c = str.match(/a/g)) === null || _c === void 0 ? void 0 : _c.forEach((x, i) => {
    console.log(`${i} - ${x}`);
});
// m : 개행된 다음 줄도 검색,세번째 줄도 검색은 g 플래그와 혼합 
str = "Hello World and\nPower Hello?\nPower Overwhelming!!";
(_d = str.match(/^Power/gm)) === null || _d === void 0 ? void 0 : _d.forEach((x, i) => {
    console.log(`${i} - ${x}`);
});
str = "abcABC";
// 대소문자 a 검색
str.match(/a/gi); // (2) ["a", "A"]
(_e = str.match(/a/gi)) === null || _e === void 0 ? void 0 : _e.forEach((x, i) => console.log(`${i} - ${x}`));
...
(_f = str.match(/banana$/gi)) === null || _f === void 0 ? void 0 : _f.forEach((x, i) => console.log(`${i} - ${x}`));
// ?            : 없거나 힌개만 있거나, /banana?/
(_g = str.match(/Apple?/gi)) === null || _g === void 0 ? void 0 : _g.forEach((x, i) => console.log(`${i} - ${x}`));
reg = new RegExp(/World*/);
console.log(`World exit once -> ${reg.test(str)}`);
// *            : 없거나 여러개 있거나, 
(_h = str.match(/apple*/g)) === null || _h === void 0 ? void 0 : _h.forEach((x, i) => console.log(`${i} - ${x}`));
// +            : 최소 한개 or 이상
let ko = 'kokokoko'.match(/ko+/); // "ko"
let koo = 'kooookoooo'.match(/ko+/); // "koooo"
console.log(`ko+ ${ko}, koo++ ${koo}`);
koo === null || koo === void 0 ? void 0 : koo.forEach(x => console.log(`koo => ${x}`));
